 ...
 *   2. Host page loads this script: <script src="https://aftercare.com/widget/aftercare-text.js" defer></script>
 *   3. Script renders the full inbox UI and manages the nav badge
 *
 * OPTIONAL:
...
(function () {
  ...
  function init() {
    ...
    if (!root.offsetParent && !root.offsetWidth) {
      ...
      // Also try rendering immediately in case it's just hidden
      render(root);
      return;
    }
    render(root);
