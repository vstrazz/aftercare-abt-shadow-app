...
(function () {
  ...
  const DEFAULT_FIREBASE_DB_URL = 'https://aftercare-app-api-18edbb932ed8.herokuapp.com/api';
  ...
  function connectInboxSignal(root, accountId) {
    ...
    var config = getConfig(root);
    if (!accountId || !config.firebaseDbUrl || config.firebaseDbUrl === 'https://aftercare-app-api-18edbb932ed8.herokuapp.com/api') return;
